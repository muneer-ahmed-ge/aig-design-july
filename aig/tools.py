...
@tool
def get_work_order_id_by_name(work_order_name: str, question: str) -> str:
    """API for getting the work order id given work order name like WO-00000000"""
    return print_tool("get_work_order_id_by_name", "work_order_name", work_order_name, question)


@tool
def get_installed_product_id_by_name(installed_product_name: str, question: str) -> str:
    """API for getting work order for installed product name eg: Ultrasound Logic series 2"""
    return print_tool("get_installed_product_id_by_name", "installed_product_name", installed_product_name, question)


@tool
def get_work_order_ids_for_installed_product_id(installed_product_id: str, question: str) -> str:
    """API for getting work order ids for installed product id"""
    return print_tool("get_work_order_ids_for_installed_product_id", "installed_product_id", installed_product_id, question)


@tool
def get_installed_product_id_for_work_order_id(work_order_id: str, question: str) -> str:
    """API for getting installed product id given work order id"""
    return print_tool("get_installed_product_id_for_work_order_id", "work_order_id", work_order_id, question)
...
def get_product_id_for_installed_product_id(installed_product_id: str, question: str) -> str:
    ...
    return print_tool("get_product_id_for_installed_product_id", "installed_product_id", installed_product_id, question)
...
@tool
def query_records_by_name(name: str, question: str) -> str:
    """API for searching records given name"""
    return print_tool("query_records_by_name", "name", name, question)


@tool
def get_product_id_by_name(product_name: str, question: str) -> str:
    """API for getting product id given product name"""
    return print_tool("get_product_id_by_name", "product_name", product_name, question)
...
def print_tool(tool_name: str, parameter_name: str, parameter_value: str, question: str) -> str:
