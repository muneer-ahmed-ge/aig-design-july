...
from aig.tools import get_work_order_id_by_name, get_installed_product_id_by_name, \
    get_work_order_ids_for_installed_product_id, get_installed_product_id_for_work_order_id, \
    get_product_id_for_installed_product_id, get_service_history_for_work_order_id, \
    get_service_history_for_installed_product_id, query_records_by_name, get_product_id_by_name, knowledge_access, \
    schedule_management
...
tools = [
    get_work_order_id_by_name, get_installed_product_id_by_name, get_work_order_ids_for_installed_product_id,
    get_installed_product_id_for_work_order_id, get_product_id_for_installed_product_id,
    get_service_history_for_work_order_id, get_service_history_for_installed_product_id, query_records_by_name,
    get_product_id_by_name, knowledge_access, schedule_management,
]
